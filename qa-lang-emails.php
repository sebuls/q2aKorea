...
*/
	...
	return array(
		...
		'u_approved_body' => "당신은 여기에 새 사용자 프로필을 볼 수 있습니다:\n\n^url\n\n고맙습니다,\n\n^site_title",
		'u_approved_subject' => '당신은 이제 ^site_title 사용자로 승인 되었습니다',

		'wall_post_subject' => '당신의 ^site_title 담벼락에 글이 쓰여졌습니다.',
		'wall_post_body' => "^f_handle 에서 사용자 담벼락에 올렸습니다 ^site_title:\n\n^open^post^close\n\n이 게시물에 응답 할 수있습니다:\n\n^url\n\n고맙습니다,\n\n^site_title",

		'welcome_body' => "^site_title 에 등록 해 주셔서 고맙습니다.\n\n^custom^confirmYour 다음과 같이 로그인 세부 사항:\n\n사용자이름: ^handle\n이메일: ^email\n\n나중에 참조 할 수 있도록 안전 정보를 보관하십시오.\n\n고맙습니다,\n\n^site_title\n^url",
